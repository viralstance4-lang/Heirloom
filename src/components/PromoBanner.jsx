...
const BG = 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=1920&h=900&q=82';
    ...
    <section className="relative overflow-hidden" style={{ minHeight: 520 }}>
      ...
      <img
        ...
        onError={e => {
          ...
          e.currentTarget.parentNode.style.background = 'linear-gradient(135deg,#5a2e3b,#3d1f28)';
        }}
      />
      ...
      <div className="relative z-10 h-full flex items-center" style={{ minHeight: 520 }}>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a href="#" className="btn-outline text-white border-white/50 hover:border-gold hover:text-gold">
              Book a Consultation
            </a>
          </div>
        </div>
